        ...
        try:
            ...
            try:
                ...
                if test_response.get("error") and "login_url" in str(test_response.get("error", {})):
                    ...
                    if        login_url = error_data["data"].get("login_url")
            ...
            try:
                async with httpx.AsyncClient() as login_client:
                    ...
                    if login_response.status_code == 200:
                        ...
                        logger.info("✅ Fi MCP authentication successful", mobile_number="scenario": session_data["scenario"]
                        }
                    else:
                        return {
                            "success": False,
                            "message": f"Authentication failed: HTTP {login_response.status_code_error:
